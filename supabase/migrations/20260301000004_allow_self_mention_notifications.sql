-- Allow self-mentions in loan chatter so users can tag themselves
-- (useful for testing and personal bookmarking on loan comments).
-- Previously the trigger skipped creating notifications for self-mentions.
