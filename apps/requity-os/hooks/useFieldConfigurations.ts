...
const FALLBACK_FIELDS: Record<string, FieldConfigEntry[]> = {
  loan_details: [
    ...
    { id: "f-ld-8", module: "loan_details", field_key: "loan_amount", field_label: "Loan Amount", field_type: "currency", column_position: "left", display_order: 8, is_visible: true, is_locked: false, is_admin_created: false, dropdown_options: null, is_archived: false },
    { id: "f-ld-9", module: "loan_details", field_key: "interest_rate", field_label: "Rate", field_type: "percentage", column_position: "right", display_order: 9, is_visible: true, is_locked: false, is_admin_created: false, dropdown_options: null, is_archived: false },
    { id: "f-ld-10", module: "loan_details", field_key: "ltv", field_label: "LTV", field_type: "percentage", column_position: "left", display_order: 10, is_visible: true, is_locked: false, is_admin_created: false, dropdown_options: null, is_archived: false },
    { id: "f-ld-11", module: "loan_details", field_key: "dscr_ratio", field_label: "DSCR", field_type: "number", column_position: "right", display_order: 11, is_visible: true, is_locked: false, is_admin_created: false, dropdown_options: null, is_archived: false },
    { id: "f-ld-12", module: "loan_details", field_key: "loan_term_months", field_label: "Term", field_type: "number", column_position: "left", display_order: 12, is_visible: true, is_locked: false, is_admin_created: false, dropdown_options: null, is_archived: false },
    { id: "f-ld-13", module: "loan_details", field_key: "points", field_label: "Points", field_type: "percentage", column_position: "right", display_order: 13, is_visible: true, is_locked: false, is_admin_created: false, dropdown_options: null, is_archived: false },
  ],
  property: [
