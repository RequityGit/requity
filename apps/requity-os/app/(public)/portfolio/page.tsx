        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <footer>
            <div className="footer-grid">
              ...
              <div className="footer-col"><h4>Lending</h4><Link href="/lending">Loan Programs</Link><Link href="https://requitygroup.com/lending/apply">Request a Quote</Link><Link href="https://requitygroup.com/lending/apply">Loan Application</Link><Link href="/borrower-faq">Borrower FAQ</Link></div>
            </div>
