...
export const MERGE_VARIABLES: TemplateVariable[] = [
  ...
  { key: "action_url", label: "Action URL", example: "https://app.requitygroup.com" },
  { key: "preferences_url", label: "Preferences URL", example: "https://app.requitygroup.com/settings/notifications" },
];
