                  ...
                  <td className="px-3 py-2 text-right">
                    <div className="inline-flex items-center justify-end">
                      ...
                      <input
                        ...
                        className="w-[90px] text-right text-[12px] num font-medium bg-transparent outline-none border border-transparent rounded-md px-1.5 py-0.5 -my-0.5 hover:border-border hover:bg-muted/40 focus:border-primary/60 focus:bg-background focus:ring-1 focus:ring-primary/20 transition-colors"
                      />
                    </div>
                  </td>
              ...
              <div className="flex items-center justify-between py-2 px-3 rounded-lg bg-muted/30 border">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="w-[40px] text-right text-[12px] num font-medium bg-transparent outline-none border border-transparent rounded-md px-1 py-0.5 hover:border-border hover:bg-muted/40 focus:border-primary/60 focus:bg-background transition-colors"
                  />
                            ...
                            <td className="h-9 px-[10px] text-right border-b">
                              <div className="inline-flex items-center justify-end">
                                ...
                                <input
                                  ...
                                  className="w-[100px] text-right text-[12px] num font-medium bg-transparent outline-none border border-transparent rounded-md px-1.5 py-0.5 -my-0.5 hover:border-border hover:bg-muted/40 focus:border-primary/60 focus:bg-background focus:ring-1 focus:ring-primary/20 transition-colors"
                                />
                              </div>
                            </td>
                            <td className="h-9 px-[10px] text-center border-b">
