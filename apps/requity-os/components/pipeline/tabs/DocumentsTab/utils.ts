 ...
 * Conditions use the same stage names as deals (lead, analysis, negotiation, execution, closed).
 */
 ...
 * Since condition stages now match deal stages 1:1, the ceiling is the deal stage itself.
 */
