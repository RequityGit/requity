          ...
          <div key={row.label} className="flex items-center py-[3px] px-4">
            ...
            {row.vals.map((v, i) => (
              <div key={i} className="flex-1 text-right px-3">
                {v ? (
                  <span className="text-[10px] num font-semibold text-foreground/70 border border-transparent rounded px-1 py-0.5 hover:border-border hover:bg-muted/40 cursor-text transition-colors">
                    {v}
                  </span>
                ) : (
              ...
              <div className="w-[240px] shrink-0 flex items-center gap-1.5">
                ...
                <span className="inline-flex items-center gap-0.5 rounded bg-muted px-1.5 py-[1px] border border-border/40">
                  <input
                    ...
                    className="w-[28px] bg-transparent text-[10px] num font-semibold text-foreground text-right outline-none border border-transparent rounded px-0.5 py-0.5 hover:border-border hover:bg-muted/40 focus:border-primary/60 focus:bg-background transition-colors"
                  />
                ...
                return (
                  <div key={i} className="flex-1 text-right px-3 group/cell relative">
                    ...
                    <div className={cn(
                      ...
                      i === 1 && !exp.overridden
                        ? "text-foreground border border-transparent rounded px-1 py-0.5 hover:border-border hover:bg-muted/40 cursor-text transition-colors"
                        : i === 1 && exp.overridden
                          ? "text-foreground border border-transparent rounded px-1 py-0.5 hover:border-amber-400/40 hover:bg-amber-500/5 cursor-text transition-colors"
                          : "text-foreground/80"
                    )}>
                      {fmtDollar(v)}
                    </div>
