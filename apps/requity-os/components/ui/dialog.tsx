  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "md:bottom-auto md:left-[50%] md:right-auto md:top-[50%] md:max-w-lg md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg md:max-h-[85vh]",
    ...
    >
      {/* Mobile drag handle */}
      <div className="mx-auto w-10 h-1 rounded-full bg-muted-foreground/30 mb-2 md:hidden" />
      {children}
