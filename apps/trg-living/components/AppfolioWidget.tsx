...
export default function AppfolioWidget({ listingUrl }: { listingUrl: string | null }) {
    ...
    if (!safeUrl) {
        return (
            <div className="aspect-video bg-slate-50 rounded-[1rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center p-12 text-center">
    ...
    return (
        <div className="w-full rounded-[1rem] overflow-hidden border-[12px] border-slate-50 shadow-2xl bg-white">
            <iframe 
                src={safeUrl}
