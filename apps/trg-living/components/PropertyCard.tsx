...
export default function PropertyCard({ property }: PropertyCardProps) {
    const imageUrl = property.featured_media?.file_path
        ? `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/trg-living-media/${property.featured_media.file_path}`
        : null;
        ...
        >
            ...
            <div className="p-6">
                ...
                <p className="text-sm text-slate-500 font-medium mt-1">
                    {property.city}{property.state_code ? `, ${property.state_code}` : ''}
                </p>
